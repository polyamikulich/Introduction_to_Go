...
type AccountsClient interface {
	...
	PatchAccount(ctx context.Context, in *PatchAccountReq, opts ...grpc.CallOption) (*Empty, error)
	ChangeAccount(ctx context.Context, in *ChangeAccountReq, opts ...grpc.CallOption) (*Empty, error)
...
func NewAccountsClient(cci grpc.ClientConnInterface) AccountsClient {
	return &accountsClient{cci}
}

func (c *accountsClient) CreateAccount(ctx context.Context, in *CreateAccountReq, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)

	err := c.cci.Invoke(ctx, "/proto.Accounts/CreateAccount", in, out, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *accountsClient) GetAccount(ctx context.Context, in *GetAccountReq, opts ...grpc.CallOption) (*GetAccountResp, error) {
	out := new(GetAccountResp)

	err := c.cci.Invoke(ctx, "/proto.Accounts/GetAccount", in, out, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *accountsClient) PatchAccount(ctx context.Context, in *PatchAccountReq, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)

	err := c.cci.Invoke(ctx, "/proto.Accounts/PatchAccount", in, out, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *accountsClient) ChangeAccount(ctx context.Context, in *ChangeAccountReq, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)

	err := c.cci.Invoke(ctx, "/proto.Accounts/ChangeAccount", in, out, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *accountsClient) DeleteAccount(ctx context.Context, in *DeleteAccountReq, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)

	err := c.cci.Invoke(ctx, "/proto.Accounts/DeleteAccount", in, out, opts...)
	if err != nil {
		return nil, err
	}
...
type AccountsServer interface {
	...
	PatchAccount(context.Context, *PatchAccountReq) (*Empty, error)
	ChangeAccount(context.Context, *ChangeAccountReq) (*Empty, error)
...
func (UnimplementedAccountsServer) CreateAccount(context.Context, *CreateAccountReq) (*Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateAccount not implemented")
}
func (UnimplementedAccountsServer) GetAccount(context.Context, *GetAccountReq) (*GetAccountResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetAccount not implemented")
}
func (UnimplementedAccountsServer) DeleteAccount(context.Context, *DeleteAccountReq) (*Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeleteAccount not implemented")
}
func (UnimplementedAccountsServer) PatchAccount(context.Context, *PatchAccountReq) (*Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PatchAccount not implemented")
}
func (UnimplementedAccountsServer) ChangeAccount(context.Context, *ChangeAccountReq) (*Empty, error) {
...
func _Accounts_CreateAccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AccountsServer).CreateAccount(ctx, req.(*CreateAccountReq))
	}
...
func _Accounts_PatchAccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AccountsServer).PatchAccount(ctx, req.(*PatchAccountReq))
	}
...
func _Accounts_ChangeAccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AccountsServer).ChangeAccount(ctx, req.(*ChangeAccountReq))
	}
...
func _Accounts_DeleteAccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AccountsServer).DeleteAccount(ctx, req.(*DeleteAccountReq))
	}
...
func _Accounts_GetAccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AccountsServer).GetAccount(ctx, req.(*GetAccountReq))
	}
